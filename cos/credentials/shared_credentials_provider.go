...
var (
	...
	//
	// @readonly
	ErrSharedCredentialsHomeNotFound = coserr.New("UserHomeNotFound", "user home directory not found.", nil)
)
...
func loadProfile(filename, profile string) (Value, error) {
	...
	if err != nil {
		return Value{ProviderName: SharedCredsProviderName}, coserr.New("SharedCredsLoad", "failed to load shared credentials file", err)
	}
